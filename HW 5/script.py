...
# for attempt_num, attempt in enumerate(itertools.product('123456', repeat=4), 1):
#     attempt_str = ''.join(attempt)
#     print(f"Trying: {attempt_str}")
#     if attempt_str == password:
#         print(f"Password match (Found in {attempt_num} attempts)")
#         break
